function slf_on_colform_loaded( col_form_id ){
	...
	var mceInit_loc = {theme:"modern",skin:"lightgray",language:"en",formats:{alignleft: [{selector: "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li",
	 ...
	 selector:"#asdd",resize:"vertical",menubar:false,wpautop:true,indent:false,toolbar1:"bold,italic,strikethrough,bullist,numlist,blockquote,hr,alignleft,aligncenter,alignright,link,unlink,wp_more,spellchecker,fullscreen,wp_adv,wbk_service_name_button,wbk_category_names_button,wbk_customer_name_button,wbk_appointment_day_button,wbk_appointment_time_button,wbk_appointment_id_button,wbk_customer_phone_button,wbk_customer_email_button,wbk_customer_comment_button,wbk_customer_custom_button,wbk_items_count,wbk_total_amount,wbk_payment_link,wbk_cancel_link,wbk_tomorrow_agenda,wbk_group_customer,wbk_multiple_loop,wbk_admin_cancel_link,wbk_admin_approve_link,wbk_customer_ggcl_link",toolbar2:"formatselect,underline,alignjustify,forecolor,pastetext,removeformat,charmap,outdent,indent,undo,redo,wp_help",toolbar3:"",toolbar4:"",tabfocus_elements:":prev,:next",body_class:"asdd locale-en-us"};
