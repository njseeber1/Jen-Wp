...
<div class="wrap">
    ...
    <div class="notice notice-warning is-dismissible"><p>Please, note that Email notifications (except administrator's message options), PayPal, Google Calendar and CSV export elements are for demo purpose only. To unlock notifications, payment and csv-export features, please, upgrade to Premium version. <a  rel="noopener"  href="https://codecanyon.net/item/appointment-booking-for-wordpress-webba-booking/13843131?ref=WebbaPlugins" target="_blank">Upgrade now</a>. </p>
    ...
    <div class="row">
        ...
        ?>
            <tr id="row_<?php echo $service->getId(); ?>">
                    ...
                    <td>                
                        <div id="value_price_<?php echo $service->getId(); ?>" class="value_container"><?php echo number_format( $service->getPrice(), 2 ) ?></div>
                    </td>                       
            </tr>
        <?php
            }
