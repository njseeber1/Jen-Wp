        ...
        <div class="header-inner">
                ...
                <?php if( get_theme_mod('custom_logo')){?>
                        <span class="logostyle">
								<?php skt_girlie_the_custom_logo(); ?>
                        </span>
						<center><?php bloginfo( 'description' ); ?></center>
                <?php } else {?>
                <span class="logostyle">
								<?php skt_girlie_the_custom_logo(); ?>
                ...
                <div class="toggle">
                <a class="toggleMenu" href="<?php echo esc_url('#');?>"><?php _e('Menu','skt-girlie'); ?></a>
                </div><!-- toggle -->
                <div class="nav">                  
...
?>		
 ...
 <?php if (is_front_page() || is_home()) { ?>
       <section id="wrapsecond" class="pagewrap2">
            	<div class="container">
                    <div class="services-wrap" <?php if( get_theme_mod( 'hide_slider' ) != '') { ?> style="margin-top:0px !important;"<?php } ?>>
